...
${AppNoOrganizationAuthorizedDiffEntity}    {"error":"unauthorized","error_description":"No organization access authorized"}
...
${AppRegistrationNoOpenDiffEntity}    {"error":"unauthorized","error_description":"Open registration doesn't allow, so register user need token,"}
...
${UserUnAuthorizedDiffEntity}    {"error":"unauthorized","error_description":"Subject does not have permission [applications:%s:%s:/users%s]"}
...
${NoAdminUserAccessAuthorizedDiffEntity}    {"error":"unauthorized","error_description":"No admin user access authorized"}
...
${TokenAuthorizationIsBlankDiffEntity}    {"error":"group_authorization","error_description":"token is blank!"}
...
${UnableToAuthenticateDiffEntity}    {"error":"unauthorized","error_description":"Unable to authenticate (OAuth)"}
...
${EasemobSecurityExceptionDiffEntity1}    {"error":"auth_bad_access_token","error_description":"Unable to authenticate due to corrupt access token"}
...
${EasemobSecurityExceptionDiffEntity}    {"error":"unauthorized","error_description":"Unable to authenticate (OAuth)"}
