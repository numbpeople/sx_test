...
渠道指定规则(上下班时间指定)(/v1/tenants/{tenantId}/channel-binding
    [Documentation]    设置路由规则：
    ...
    ...    规则为：入口/关联指定技能组规则
    ...
...
关联指定规则(上下班时间指定)(/v1/tenants/{tenantId}/channel-data-binding)
    [Documentation]    设置路由规则：
    ...
    ...    规则为：关联指定技能组规则
    ...
...
渠道和关联指定规则(上下班时间指定)(/v1/tenants/{tenantId}/channel-binding)
    [Documentation]    设置路由规则：
    ...
    ...    规则为：渠道/关联指定技能组规则
    ...
