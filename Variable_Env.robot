*** Variables ***
&{RestRes}        RestUrl=${URLDeclare.rest1_hsb}    username=easemob@easemob.com    password=huanxintest1024     alias=    # 用例执行环境配置、console登录账号密码
&{URLDeclare}     bj=https://a1.easemob.com    rest1_gray=https://a2.easemob.com    rest1_hk=https://hk.test.easemob.com    rest1_hsb=http://a1-hsb.easemob.com    rest2_sdb=http://39.96.116.29:8080    # rest1.0灰度：https://a2.easemob.com、rest1.0沙箱：https://a1-hsb.easemob.com、rest2.0沙箱: http://39.96.116.29:8080、北京集群：https://a1.easemob.com
...
&{ModelCaseRunStatus}    OrgToken_ContentType=${RunStatus.RUN}    EmptyOrgToken_EmptyContentType=${RunStatus.RUN}    OrgToken_EmptyContentType=${RunStatus.RUN}    EmptyOrgToken_ContentType=${RunStatus.RUN}    BestToken_ContentType=${RunStatus.NORUN}    AppToken_ContentType=${RunStatus.RUN}    userToken_ContentType=${RunStatus.RUN}    # 模块用例的多种组合执行状态
