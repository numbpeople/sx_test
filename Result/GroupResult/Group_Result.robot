...
*** Variables ***
${CreateChatgroup}    {"action":"post","application":"e1af6e90-fccf-11e7-8cd3-5d660b6f51f2","uri":"http://a1-mesos.easemob.com/talent-leoli123/test/chatgroups","entities":[],"data":{"groupid":"81787263975425"},"timestamp":1557396813145,"duration":0,"organization":"talent-leoli123"}
${CreateChatgroupDiffEntity}    {"action":"post","application":"%s","entities":[],"organization":"%s"}
...
${GroupNoAuthorizationDiffEntity}    {"error":"group_authorization","error_description":"token is blank!"}
...
${GroupMemberNotFoundDiffEntity}    {"error":"resource_not_found","error_description":"username %s doesn\\'t exist!"}
...
${GroupPublicNotFoundDiffEntity}    {"error":"invalid_parameter","error_description":"group must contain public field!"}
...
${ChatgroupIdNotFoundDiffEntity}    {"error":"resource_not_found","error_description":"grpID %s does not exist!"}
...
${GetChatgroupDetailDiffEntity}    {"action":"get","application":"%s","entities":[],"data":[{"id":"%s","name":"%s","description":"%s","membersonly":%s,"allowinvites":%s,"maxusers":%s,"owner":"%s","custom":"","affiliations_count":1,"affiliations":[{"owner":"%s"}],"public":%s}],"organization":"%s","count":1}
...
${GetChatgroupDetailGroupIdNotFoundDiffEntity}    {"error":"service_resource_not_found","error_description":"do not find this group:%s"}
...
${ShieldGroupMessageDiffEntity}    {"action":"%s","application":"%s","entities":[],"data":{"result":%s,"action":"%s","user":"%s","groupid":"%s"},"organization":"%s"}    
...
${UnShieldGroupMessageDiffEntity}    {"action":"%s","application":"%s","entities":[],"data":{"result":%s,"action":"%s","user":"%s","groupid":"%s"},"organization":"%s"}    
&{UnShiledGroupMessageDictionary}    statusCode=200    reponseResult=${UnShieldGroupMessage}

${GetMemberWhoOpenShield}    {"action":"get","application":"7efd2c73-4253-46c1-a23b-5f4290411a16","uri":"http://a1-hsb.easemob.com/easemob-demo/imautotest-5779896234/chatgroups/159607650582529/shield","entities":[],"data":[],"timestamp":1631612117524,"duration":0,"organization":"easemob-demo","count":0}
${GetMemberWhoOpenShieldDiffEntity}    {"action":"%s","application":"%s","entities":[],"data":[],"organization":"%s","count":%s}        
...
${UsersJoinGroupsInBatchesDiffEntity}    {"action":"post","application":"%s","entities":[],"data":[{"id":"%s","result":true},{"id":"%s","result":true}],"organization":"%s"}
&{UsersJoinGroupsInBatchesDictionary}    statusCode=200    reponseResult=${UsersJoinGroupsInBatches}

${BanGroupMessage}    {"action":"put","application":"ed12d486-881b-4346-a784-3ca083f88d7b","uri":"http://a1-hsb.easemob.com/easemob-demo/imautotest-4703902562/chatgroups/159675625570305/ban","entities":[],"data":{"mute":true},"timestamp":1631676944214,"duration":0,"organization":"easemob-demo"}
${BanGroupMessageDiffEntity}    {"action":"put","application":"%s","entities":[],"data":{"mute":%s},"organization":"%s"}
&{BanGroupMessageDictionary}    statusCode=200    reponseResult=${BanGroupMessage}

${AllowGroupMessage}    {"action":"delete","application":"ed12d486-881b-4346-a784-3ca083f88d7b","uri":"http://a1-hsb.easemob.com/easemob-demo/imautotest-4703902562/chatgroups/159675625570305/ban","entities":[],"data":{"mute":false},"timestamp":1631676944214,"duration":0,"organization":"easemob-demo"}
${AllowGroupMessageDiffEntity}    {"action":"put","application":"%s","entities":[],"data":{"mute":%s},"organization":"%s"}
...
${GetFileList}    {"action":"get","application":"a379d738-bf5c-4585-b331-435f4b05b0c4","uri":"http://a1-hsb.easemob.com/easemob-demo/imautotest-0355406389/chatgroups/159942570999809/share_files","entities":[],"data":[],"timestamp":1631931523309,"duration":0,"organization":"easemob-demo","count":0}
${GetFileListDiffEntity}    {"action":"%s","application":"%s","organization":"%s"}
