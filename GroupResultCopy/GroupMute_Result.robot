...
${ChatgroupUserMuteDiffEntity}    {"action":"%s","application":"%s","entities":[],"data":[{"result":true,"user":"%s"}],"organization":"%s","applicationName":"%s"}
...
${RemoveChatgroupUserMute}    {"action":"delete","application":"eb2f1b70-7ad0-11e9-a561-534f55f6b5c3","uri":"http://a1-hsb.easemob.com/1104190221201050/imautotest-1377913191/chatgroups/82773470674945/mute/imautotest-2269259556","entities":[],"data":[{"result":true,"user":"imautotest-2269259556"}],"timestamp":1558337334295,"duration":1,"organization":"1104190221201050","applicationName":"imautotest-1377913191"}
${RemoveChatgroupUserMuteDiffEntity}    {"action":"%s","application":"%s","entities":[],"data":[{"result":true,"user":"%s"}],"organization":"%s","applicationName":"%s"}
${GetChatgroupUserMuteList}    {"action":"post","application":"caf2ea70-7afe-11e9-a161-3dd64d87740a","uri":"http://a1-hsb.easemob.com/1104190221201050/imautotest-8767242519/chatgroups/82794130767873/mute","entities":[],"data":[{"expire":1558443436981,"user":"imautotest-8722232287"}],"timestamp":1558357037144,"duration":0,"organization":"1104190221201050","applicationName":"imautotest-8767242519"}
${GetChatgroupUserMuteListDiffEntity}    {"action":"%s","application":"%s","entities":[],"data":[{"user":"%s"}],"organization":"%s","applicationName":"%s"}
...
${RemoveMuteByRoleDiffEntity}    {"action":"delete","application":"%s","data":[{"result":%s,"user":"%s"}],"entities":[],"organization":"easemob-demo","params":{"role":["member"]},"properties":{}}
