...
${AddFriendDiffEntity}    {"action":"post","application":"%s","path":"/users/%s/contacts","entities":[{"uuid":"%s","type":"user","username":"%s","activated":true,"nickname":"%s"}],"organization":"%s","applicationName":"%s"}
...
${RemoveFriendDiffEntity}    {"action":"delete","application":"%s","path":"/users/%s/contacts","entities":[{"uuid":"%s","type":"user","username":"%s","activated":true,"nickname":"%s"}],"organization":"%s","applicationName":"%s"}
