...
${CreateChatroomWithNameFiledDiscarded}    {"error":"invalid_parameter","timestamp":1558606905572,"duration":0,"error_description":"chatroom must contain title/name field!"}
${CreateChatroomWithNameFiledDiscardedDiffEntity}    {"error":"invalid_parameter","error_description":"chatroom must contain title/name field!"}
${CreateChatroomWithOwnerFiledDiscarded}    {"error":"invalid_parameter","timestamp":1558607071240,"duration":0,"error_description":"owner must be provided"}
${CreateChatroomWithOwnerFiledDiscardedDiffEntity}    {"error":"invalid_parameter","error_description":"owner must be provided"}
...
${ModifyChatroomWithMaxUserIsLargerThanCurrent}    {"error":"forbidden_op","timestamp":1558699424653,"duration":0,"error_description":"current user count is larger than the maxUsers that you want to update !"}
${ModifyChatroomWithMaxUserIsLargerThanCurrentDiffEntity}    {"error":"forbidden_op","error_description":"current user count is larger than the maxUsers that you want to update !"}
