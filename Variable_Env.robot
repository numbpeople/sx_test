*** Variables ***
&{RestRes}        RestUrl=${URLDeclare.vip6}    username=    password=    alias=    consolealias=    # 用例执行环境配置、console登录账号密码
&{URLDeclare}     ebs=http://a1.easemob.com    hw=http://a1-hw.easemob.com    frank=http://a51.easemob.com    sgp=http://a1-sgp.easemob.com    kumu=http://a61.easemob.com
...    rest1_gray=https://a2.easemob.com    hk=https://hk.test.easemob.com    hsb=http://a1-hsb.easemob.com
