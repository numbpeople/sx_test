...
添加好友(/{orgName}/{appName}/users/{ownerUsername}/contacts/users/{friendUsername})
    ...
    ${contentType.JSON}    ${Token.userToken}    ${AddFriendDictionary.statusCode}    ${AddFriendDictionary.reponseResult}    ${AddFriendDiffEntity}    ${ModelCaseRunStatus.userToken_ContentType}
添加单个不存在的好友(/{orgName}/{appName}/users/{ownerUsername}/contacts/users/{friendUsername})
    ...
    ${contentType.JSON}    ${Token.userToken}    ${UserNotFoundDictionary.statusCode}    ${UserNotFoundDictionary.reponseResult}    ${UserNotFoundDiffEntity}    ${ModelCaseRunStatus.userToken_ContentType}
移除好友(/{orgName}/{appName}/users/{ownerUsername}/contacts/users/{friendUsername})
    ...
    ${contentType.JSON}    ${Token.userToken}    ${RemoveFriendDictionary.statusCode}    ${RemoveFriendDictionary.reponseResult}    ${RemoveFriendDiffEntity}    ${ModelCaseRunStatus.userToken_ContentType}
...
获取IM用户的好友列表(/{orgName}/{appName}/users/{ownerUsername}/contacts/users/{friendUsername})
    ...
    ${contentType.JSON}    ${Token.userToken}    ${GetFriendDictionary.statusCode}    ${GetFriendDictionary.reponseResult}    ${GetFriendDiffEntity}    ${ModelCaseRunStatus.userToken_ContentType}
...
添加IM用户的黑名单(/{orgName}/{appName}/users/{ownerUsername}/blocks/users)
    ...
    ${contentType.JSON}    ${Token.userToken}    ${UserBlackListDictionary.statusCode}    ${UserBlackListDictionary.reponseResult}    ${UserBlackListDiffEntity}    ${ModelCaseRunStatus.userToken_ContentType}
...
添加IM用户的黑名单-黑名单用户不存在(/{orgName}/{appName}/users/{ownerUsername}/blocks/users)
    ...
    ${contentType.JSON}    ${Token.userToken}    ${BlackUserNotFoundDictionary.statusCode}    ${BlackUserNotFoundDictionary.reponseResult}    ${BlackUserNotFoundDiffEntity}    ${ModelCaseRunStatus.userToken_ContentType}
移除IM用户的黑名单(/{orgName}/{appName}/users/{ownerUsername}/blocks/users/{blockedUsername})
    ...
    ${contentType.JSON}    ${Token.userToken}    ${RemoveBlacklistUserDictionary.statusCode}    ${RemoveBlacklistUserDictionary.reponseResult}    ${RemoveBlacklistUserDiffEntity}    ${ModelCaseRunStatus.userToken_ContentType}
...
获取IM用户的黑名单(/{orgName}/{appName}/users/{ownerUsername}/blocks/users)
    ...
    ${contentType.JSON}    ${Token.userToken}    ${GetUserBlackListDictionary.statusCode}    ${GetUserBlackListDictionary.reponseResult}    ${GetUserBlackListDiffEntity}    ${ModelCaseRunStatus.userToken_ContentType}
