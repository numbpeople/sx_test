...
&{AdminUser}      username=0321t1@t.com    password=test2015    status=Hidden    roles=    tenantId=    maxServiceSessionCount=    wsconn=0
...
...               objectType=O_AGENT    locale=zh_CN    order=stateCreateTime    username=
...
&{SmsRemindEntity}    id=4    status=enable    remindType=remindType    remindName=
