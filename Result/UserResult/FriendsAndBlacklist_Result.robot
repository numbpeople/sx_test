...
# ${BlackApplyAddFriendDiffEntity}    {"error":"illegal_argument","exception":"java.lang.IllegalArgumentException","error_description":"attempt to adding new block[%s] for user[%s],but user[%s] not found."}
...
${BlackUserNotFoundDiffEntity}    {"error":"service_resource_not_found","exception":"UserNotFoundException","error_description":"Service resource not found"}
