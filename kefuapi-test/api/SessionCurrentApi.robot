...
/v1/tenants/{tenantId}/servicesessioncurrents
    ...
    ${params}    set variable    page=${FilterEntity.page}&per_page=${FilterEntity.per_page}&state=${FilterEntity.state}&isAgent=${FilterEntity.isAgent}&categoryId=${FilterEntity.categoryId}&subCategoryId=${FilterEntity.subCategoryId}&sortOrder=${FilterEntity.sortOrder}&beginDate=${DateRange.beginDate}&endDate=${DateRange.endDate}&visitorName=${FilterEntity.visitorName}&agentName=${agent.username}&userTagIds=${FilterEntity.userTagIds}
