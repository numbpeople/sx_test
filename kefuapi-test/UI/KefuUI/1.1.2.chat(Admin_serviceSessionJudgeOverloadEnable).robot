...
调度1：管理员能自动调度
    ...
    ${uiadmin}    ${uiadmin}    true    true    on    ${true}    'agent'
    ${uiadmin}    ${uiadmin}    true    true    off    ${false}    'agent'
    ${uiadmin}    ${uiadmin}    true    false    on    ${true}    'agent'
    ${uiadmin}    ${uiadmin}    true    false    off    ${true}    'agent'
    ${uiadmin}    ${uiadmin}    false    true    on    ${true}    'agent'
    ${uiadmin}    ${uiadmin}    false    true    off    ${false}    'agent'
    ${uiadmin}    ${uiadmin}    false    false    on    ${true}    'agent'
    ${uiadmin}    ${uiadmin}    false    false    off    ${true}    'agent'
