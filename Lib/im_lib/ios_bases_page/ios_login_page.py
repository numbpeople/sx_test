...
class Ios_login_page(Android_Appium_bases):
    ...
    def ios_get_ios_version_method(self):
        """:return IM首页版本号"""
        logging.debug("获取版本号")
        return self.wait_find(self.ios_version_element).text

    def ios_send_keys_user_name_method(self,date):
        """
        ...
        self.wait_find(self.ios_user_name_element).send_keys(date)
