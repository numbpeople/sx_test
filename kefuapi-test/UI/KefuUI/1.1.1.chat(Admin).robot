...
调度3：管理员能心跳调度（修改状态）
    ...
    ...    #    ${uiadmin}    ${uiadmin}    ${kefustatus[2]}    true    true
    ...    # off    # ${false}    #    ${uiadmin}    ${uiadmin}    ${kefustatus[2]}
    ...    # true    false    on    # ${true}    #    ${uiadmin}
    ...    # ${uiadmin}    ${kefustatus[2]}    true    false    off    # ${true}
    ...    #    ${uiadmin}    ${uiadmin}    ${kefustatus[2]}    false    true
    ...    # on    # ${true}    #    ${uiadmin}    ${uiadmin}    ${kefustatus[2]}
    ...    # false    true    off    # ${false}    #    ${uiadmin}
    ...    # ${uiadmin}    ${kefustatus[2]}    false    false    on    # ${true}
    ...    #    ${uiadmin}    ${uiadmin}    ${kefustatus[2]}    false    false
    ...    # off    # ${true}
    ${uiadmin}    ${uiadmin}    ${kefustatus[3]}    true    true    on    ${true}
    ...    #    ${uiadmin}    ${uiadmin}    ${kefustatus[3]}    true    true
    ...    # off    # ${false}    #    ${uiadmin}    ${uiadmin}    ${kefustatus[3]}
    ...    # true    false    on    # ${true}    #    ${uiadmin}
    ...    # ${uiadmin}    ${kefustatus[3]}    true    false    off    # ${true}
    ...    #    ${uiadmin}    ${uiadmin}    ${kefustatus[3]}    false    true
    ...    # on    # ${true}    #    ${uiadmin}    ${uiadmin}    ${kefustatus[3]}
    ...    # false    true    off    # ${false}    #    ${uiadmin}
    ...    # ${uiadmin}    ${kefustatus[3]}    false    false    on    # ${true}
    ...    #    ${uiadmin}    ${uiadmin}    ${kefustatus[3]}    false    false
    ...    # off    # ${true}
...
调度5：指定坐席能直接接起
    ...
    ${uiadmin}    ${uiadmin}    true    0    ${kefustatus[0]}
    ${uiadmin}    ${uiadmin}    true    1    ${kefustatus[0]}
    ${uiadmin}    ${uiadmin}    false    0    ${kefustatus[0]}
    ${uiadmin}    ${uiadmin}    false    1    ${kefustatus[0]}
    ${uiadmin}    ${uiadmin}    true    0    ${kefustatus[1]}
    ${uiadmin}    ${uiadmin}    false    0    ${kefustatus[1]}
    ${uiadmin}    ${uiadmin}    true    1    ${kefustatus[1]}
    ${uiadmin}    ${uiadmin}    false    1    ${kefustatus[1]}
    ${uiadmin}    ${uiadmin}    true    1    ${kefustatus[2]}
    #    ${uiadmin}    ${uiadmin}    false    1    ${kefustatus[2]}
    ${uiadmin}    ${uiadmin}    true    1    ${kefustatus[3]}
    #    ${uiadmin}    ${uiadmin}    false    1    ${kefustatus[3]}
