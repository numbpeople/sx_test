...
${InviteToGroup}    {"action":"post","application":"e019c634-e3f2-4e9c-9393-463657845f4f","uri":"http://a1-hsb.easemob.com/easemob-demo/easeim/chatgroups/157793548042241/invite","entities":[],"data":[{"result":true,"action":"invite","user":"dee2","id":"157793548042241"}],"timestamp":1629946146696,"duration":0,"organization":"easemob-demo","applicationName":"easeim"}
${InviteToGroupDiffEntity}    {"action":"post","application":"%s","entities":[],"data":[{"result":%s,"action":"invite","user":"%s","id":"%s"}],"organization":"%s","applicationName":"%s"}
&{InviteToGroupDictionary}    statusCode=200    reponseResult=${InviteToGroup}  

${ApplyToJoinIn}    {"action":"post","application":"e019c634-e3f2-4e9c-9393-463657845f4f","uri":"http://a1-hsb.easemob.com/easemob-demo/easeim/chatgroups/154605632684033/apply","entities":[],"data":{"result":true,"action":"apply","user":"dee1","id":"154605632684033"},"timestamp":1629978476754,"duration":3,"organization":"easemob-demo","applicationName":"easeim"}
${ApplyToJoinInDiffEntity}    {"action":"post","application":"%s","entities":[],"data":{"result":%s,"action":"apply","user":"%s","id":"%s"},"organization":"%s","applicationName":"%s"}
&{ApplyToJoinInDictionary}    statusCode=200    reponseResult=${ApplyToJoinIn}
        
${QuitGroup}    {"action":"delete","application":"a17c6fdb-7319-45a8-ab18-031cbb10bc6f","uri":"http://a1-hsb.easemob.com/easemob-demo/imautotest-0439460962/chatgroups/159491350921217/quit","entities":[],"data":{"result":true},"timestamp":1631501206641,"duration":4,"organization":"easemob-demo","applicationName":"imautotest-0439460962"}
${QuitGroupDiffEntity}    {"action":"%s","application":"%s","entities":[],"data":{"result":%s},"organization":"%s","applicationName":"%s"}    
&{QuitGroupDictionary}    statusCode=200    reponseResult=${QuitGroup}

${ApplyVerify}    {"action":"post","application":"160720c7-06f2-45b3-8e03-72e123214931","uri":"http://a1-hsb.easemob.com/easemob-demo/imautotest-8163396229/chatgroups/159962347143171/apply_verify","entities":[],"data":{"result":true,"action":"applyVerify","user":"imautotest-4674588577","id":"159962347143171"},"timestamp":1631950382957,"duration":1,"organization":"easemob-demo","applicationName":"imautotest-8163396229"}
${ApplyVerifyDiffEntity}    {"action":"post","application":"%s","entities":[],"data":{"result":%s,"action":"%s","user":"%s","id":"%s"},"organization":"%s","applicationName":"%s"}
&{ApplyVerifyDictionary}    statusCode=200    reponseResult=${ApplyVerify}

${InviteVerify}    {"action":"post","application":"1e653141-c3a6-476c-b96c-38234b24ab27","uri":"http://a1-hsb.easemob.com/easemob-demo/imautotest-6033120285/chatgroups/160311448502273/invite_verify","entities":[],"data":{"result":true,"action":"inviteVerify","user":"imautotest-1045555044","id":"160311448502273"},"timestamp":1632283312013,"duration":0,"organization":"easemob-demo","applicationName":"imautotest-6033120285"}
${InviteVerifyDiffEntity}    {"action":"%s","application":"%s","entities":[],"data":{"result":%s,"action":"%s","user":"%s","id":"%s"},"organization":"%s","applicationName":"%s"}
